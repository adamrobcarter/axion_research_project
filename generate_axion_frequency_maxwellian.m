function f_axion = generate_axion_frequency_maxwellian(t, f_sampling, correlation_time, f_0, axion_linewidth)

%% uncorrelated gaussian points
f_uncorrelated = sqrt(chi2rnd(3, size(t)));
...
f_renormalised = f_renormalised - mean(f_renormalised); % get it to have mean 0
